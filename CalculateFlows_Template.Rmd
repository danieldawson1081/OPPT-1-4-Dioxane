...
#Select WWTP's
Bounds=subset(fdb, c(PRIMARY_NAME== "FAYETTEVILLE-CROSS CREEK WRF" | 
                PRIMARY_NAME=="ROCKFISH CREEK WWTP" |
                PRIMARY_NAME=="ELIZABETHTOWN WASTEWATER PLAN")
               
              ) 

#ELizabeth town wastewater plant isn't showing up 

#Add in the reachcode from ISTREEM for the Brunswick DWI
FlowBounds=flowline[which(flowline$ReachCode%in%Bounds$REACHCODE | flowline$ReachCode=="03030005001431"),]
